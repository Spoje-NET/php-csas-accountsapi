...
namespace Spoje-NET\php-csas-webapi;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://www.csas.cz/webapi/api/v3/accounts';
    ...
    {
        $report  = 'PHP SDK (Spoje-NET\php-csas-webapi) Debug Report:' . PHP_EOL;
