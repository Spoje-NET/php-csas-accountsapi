...
/**
 * AccountCurrencyExchange Class Doc Comment
 *
 * @category Class
 * @package  SpojeNET\CsasAccounts
 * @author   OpenAPI Generator team
 ...
 */
class AccountCurrencyExchange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Account_currencyExchange';
    ...
    */
     ...
     * Sets targetCurrency
     *
     * @param string|null $targetCurrency Currency of the client's account
     *
     * @return self
     */
     ...
     * Sets exchangeRate
     *
     * @param float|null $exchangeRate Exchange rate used during the conversion
     *
     * @return self
     */
