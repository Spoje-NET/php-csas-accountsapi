...
class AccountCurrencyExchange implements \ArrayAccess, \JsonSerializable, ModelInterface
{
     ...
     */
    protected static string $openAPIModelName = 'Account_currencyExchange';
     ...
     * Sets targetCurrency.
     *
     * @param null|string $targetCurrency Currency of the client's account
     *
     * @return self
     */
     ...
     * Sets exchangeRate.
     *
     * @param null|float $exchangeRate Exchange rate used during the conversion
     *
     * @return self
     */
