...
/**
 * GetTransactions200ResponseTransactionsInnerEntryDetailsTransactionDetailsReferences Class Doc Comment
 *
 * @category Class
 * @package  SpojeNET\CSas
 * @author   OpenAPI Generator team
 ...
 */
class GetTransactions200ResponseTransactionsInnerEntryDetailsTransactionDetailsReferences implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTransactions_200_response_transactions_inner_entryDetails_transactionDetails_references';
    ...
    protected static array $openAPINullables = [
        'accountServicerReference' => false,
        'chequeNumber' => false
    ];
    ...
    {
        $this->setIfExists('accountServicerReference', $data ?? [], null);
        $this->setIfExists('chequeNumber', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $accountServicerReference Reference provided by the account servicer
     *
     * @return self
     */
    public function setAccountServicerReference($accountServicerReference)
    {
        if (is_null($accountServicerReference)) {
            throw new \InvalidArgumentException('non-nullable accountServicerReference cannot be null');
        }
     ...
     * Sets chequeNumber
     *
     * @param string|null $chequeNumber Cheque number
     *
     * @return self
     */
    public function setChequeNumber($chequeNumber)
    {
        if (is_null($chequeNumber)) {
            throw new \InvalidArgumentException('non-nullable chequeNumber cannot be null');
        }
