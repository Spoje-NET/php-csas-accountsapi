 ...
 */
class GetTransactions200ResponseTransactionsInnerEntryDetailsTransactionDetailsReferences implements \ArrayAccess, \JsonSerializable, ModelInterface
{
     ...
     */
    protected static string $openAPIModelName = 'getTransactions_200_response_transactions_inner_entryDetails_transactionDetails_references';
     ...
     *
     * @param null|string $accountServicerReference Reference provided by the account servicer
     *
     * @return self
     */
     ...
     * Sets chequeNumber.
     *
     * @param null|string $chequeNumber Cheque number
     *
     * @return self
     */
