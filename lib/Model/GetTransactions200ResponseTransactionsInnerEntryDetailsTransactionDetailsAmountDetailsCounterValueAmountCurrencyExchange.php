...
/**
 * GetTransactions200ResponseTransactionsInnerEntryDetailsTransactionDetailsAmountDetailsCounterValueAmountCurrencyExchange Class Doc Comment.
 *
 * @category Class
 *
 ...
 */
class GetTransactions200ResponseTransactionsInnerEntryDetailsTransactionDetailsAmountDetailsCounterValueAmountCurrencyExchange implements \ArrayAccess, \JsonSerializable, ModelInterface
{
     ...
     */
    protected static string $openAPIModelName = 'getTransactions_200_response_transactions_inner_entryDetails_transactionDetails_amountDetails_counterValueAmount_currencyExchange';
     ...
     * Sets sourceCurrency.
     *
     * @param null|string $sourceCurrency Source currency
     *
     * @return self
     */
    public function setSourceCurrency($sourceCurrency)
    {
        if (null === $sourceCurrency) {
            throw new \InvalidArgumentException('non-nullable sourceCurrency cannot be null');
        }
     ...
     * Sets targetCurrency.
     *
     * @param null|string $targetCurrency Target currency
     *
     * @return self
     */
    public function setTargetCurrency($targetCurrency)
    {
        if (null === $targetCurrency) {
            throw new \InvalidArgumentException('non-nullable targetCurrency cannot be null');
        }
     ...
     * Sets exchangeRate.
     *
     * @param null|float $exchangeRate Exchange rate used
     *
     * @return self
     */
