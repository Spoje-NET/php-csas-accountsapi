 ...
 */
class MyAccountsIdTransactionsGet400Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_my_accounts__id__transactions_get_400_response';
    ...
    public const ERROR_CODE_DT01 = 'DT01';
    public const ERROR_CODE_BAD_REQUEST = 'BAD_REQUEST';
    public const ERROR_CODE_MAX_TRANSACTIONS_EXCEEDED = 'MAX_TRANSACTIONS_EXCEEDED';
    ...
    public function getErrorCodeAllowableValues()
    {
        return [
            ...
            self::ERROR_CODE_DT01,
            self::ERROR_CODE_BAD_REQUEST,
            self::ERROR_CODE_MAX_TRANSACTIONS_EXCEEDED,
        ];
    }
