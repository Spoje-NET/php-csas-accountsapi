...
class AccountBalance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Opaque system ID of the account
     *
     * @return self
     */
     ...
     * Sets balance
     *
     * @param float|null $balance Current balance of the account
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency Currency of the account balance
     *
     * @return self
     */
