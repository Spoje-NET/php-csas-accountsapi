 ...
 */
class GetAccountStatements200ResponseStatementsInnerPeriod implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getAccountStatements_200_response_statements_inner_period';
    ...
    */
     ...
     * Sets dateFrom
     *
     * @param \DateTime|null $dateFrom The start-date of the statement period
     *
     * @return self
     */
     ...
     * Sets dateTo
     *
     * @param \DateTime|null $dateTo The end-date of the statement period
     *
     * @return self
     */
