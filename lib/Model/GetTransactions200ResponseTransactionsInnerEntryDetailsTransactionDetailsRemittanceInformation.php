 ...
 */
class GetTransactions200ResponseTransactionsInnerEntryDetailsTransactionDetailsRemittanceInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTransactions_200_response_transactions_inner_entryDetails_transactionDetails_remittanceInformation';
    ...
    */
     ...
     * Sets unstructured
     *
     * @param string|null $unstructured Unstructured remittance information
     *
     * @return self
     */
    public function setUnstructured($unstructured)
    {
        if (is_null($unstructured)) {
