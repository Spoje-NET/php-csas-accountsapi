 ...
 */
class GetTransactions200ResponseTransactionsInnerEntryDetailsTransactionDetailsRemittanceInformationStructured implements \ArrayAccess, \JsonSerializable, ModelInterface
{
     ...
     */
    protected static string $openAPIModelName = 'getTransactions_200_response_transactions_inner_entryDetails_transactionDetails_remittanceInformation_structured';
    ...
    {
        if (null === $creditorReferenceInformation) {
