 ...
 */
class GetTransactions200ResponseTransactionsInnerBankTransactionCode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTransactions_200_response_transactions_inner_bankTransactionCode';
    ...
    {
        $this->setIfExists('proprietary', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($proprietary)) {
            throw new \InvalidArgumentException('non-nullable proprietary cannot be null');
        }
