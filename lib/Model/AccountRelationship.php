 ...
 */
class AccountRelationship implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Account_relationship';
    ...
    */
     ...
     * Sets isOwner
     *
     * @param bool|null $isOwner Indicates if the authenticated user is the owner of the account
     *
     * @return self
     */
